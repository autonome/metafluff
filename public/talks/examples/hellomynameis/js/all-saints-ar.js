...
AFRAME.registerComponent('all-saints-ar', {
  init: function() {
    ...
    for (let i = 1; i <= MAX_HALOS; i++) {
      ...
      //= '<a-image id="controls" src="ar-music-ctrls.png" position="0 0 -30" scale="20 25 20"></a-image>';
      halo.setAttribute('src', 'hello_my_name_is_sticker_transparent.png');
      //halo.setAttribute('position', '0 0 -30');
